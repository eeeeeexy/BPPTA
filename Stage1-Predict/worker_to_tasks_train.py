...
from model import GCN, NodeAttnMap, UserEmbeddings, CategoryEmbeddings, WorkerFuseEmbeddings, TaskFuseEmbeddings, TransformerModel
...
def Tasktrain(args):
    ...
    # print(f'num_cats: {num_cats}', f'one_hot_rlt.shape, {one_hot_rlt.shape}')
    ...
    embed_fuse_model1 = TaskFuseEmbeddings(args.user_embed_dim, args.poi_embed_dim, args.cat_embed_dim)
    ...
    def input_traj_to_embeddings(sample, poi_embeddings):
        ...
        for idx in range(len(input_seq)):
            ...
            fused_embedding1 = embed_fuse_model1(user_embedding, poi_embedding, cat_embedding)
    ...
    for epoch in range(args.epochs):
        ...
        for b_idx, batch in enumerate(train_loader):
            ...
            if (b_idx % (args.batch * 5)) == 0:
                ...
                logging.info(f'label_seq_cat:{[poi_idx2cat_idx_dict[each] for each in batch[sample_idx][2]]}')
        ...
        with open('Preference_value/worker_to_task_preference.pkl', 'wb') as f:
