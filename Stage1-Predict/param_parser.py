...
def parameter_parser():
    parser = argparse.ArgumentParser(description="Run TaskTrain.")
    ...
    parser.add_argument('--device',
                        ...
                        help='')
    # Data
    parser.add_argument('--task_data_adj_mtx',
                        type=str,
                        default='data-process/Foursquare/task_graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--task_data_node_feats',
                        type=str,
                        default='data-process/Foursquare/task_graph_X.csv',
                        help='Graph node features path')
    parser.add_argument('--worker_data_adj_mtx',
                        type=str,
                        default='data-process/Foursquare/worker_graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--worker_data_node_feats',
                        type=str,
                        default='data-process/Foursquare/worker_graph_X.csv',
                        help='Graph node features path')
    
    parser.add_argument('--data-train',
                        type=str,
                        default='data-process/Foursquare/Foursquare_train.txt',
                        help='Training data path')
    parser.add_argument('--data-val',
                        type=str,
                        default='data-process/Foursquare/Foursquare_test.txt',
    ...
    parser.add_argument('--task-embed-dim',
                        type=int,
                        default=128,
    ...
    parser.add_argument('--cat_loss_weight',
                        type=int,
                        default=1,
                        help='Scale factor for the time loss term')
