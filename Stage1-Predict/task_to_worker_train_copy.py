...
def Tasktrain(args):
        ...
        def __init__(self, train_df):
            ...
            for traj_id in tqdm(set(train_df['worker_trajectory_id'].tolist())):
                ...
                for i in range(len(user_idxs) - 1):
                    input_seq.append((user_idxs[i], time_feature[i]))
                    label_seq.append((user_idxs[i + 1], time_feature[i + 1]))
    ...
    embed_fuse_model1 = WorkerFuseEmbeddings(args.user_embed_dim, args.task_embed_dim, args.time_embed_dim)

    # %% Model6: Sequence model
    args.seq_input_embed = args.user_embed_dim + args.task_embed_dim + args.time_embed_dim
    ...
    def input_traj_to_embeddings(sample, task_embeddings):
        ...
        for idx in range(len(input_seq)):
            ...
            fused_embedding1 = embed_fuse_model1(task_embedding, user_embedding, time_embedding)
    ...
    for epoch in range(args.epochs):
        ...
        with open('Preference_value/Foursquare_task_to_worker_preference_time_newcat1.pkl', 'wb') as f:
